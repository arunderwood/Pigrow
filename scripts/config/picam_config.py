...
def show_menu():
    ...
    print("Current settings; S = " + str(s_val) + "  C = " +
          str(c_val) + "  iso = " + str(g_val) + "  B = " + str(b_val))
    ...
    if option == "1":
        ...
        os.system("gpicview " + caps_path +
                  "test_range_s_" + str(start_v) + ".jpg")
        s_val = raw_input("Input value to use for Saturation.. ")
        show_menu()
