...
except BaseException: print("Couldn't make dirs, possinly not a pi...")
...
try:
    ...
    print("- ")
        ...
        except BaseException: print("...but it doens't seem to have worked...")
...
try:
    ...
    except BaseException:        print("Sorry, -- sudo pip install praw pexpect -- didn't work, try it manually.")
        print("")
        # raise
print(" - Using apt-get")
print("")
...
except BaseException:    print("Sorry, -- sudo apt-get --yes install python-matplotlib sshpass uvccapture mpv python-crontab-- didn't work, try it manually..")
    # raise
print("")
