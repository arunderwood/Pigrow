...
def show_menu():
    ...
    print("")
    print("Current settings; S = " + str(s_val) + "  C = " +
          str(c_val) + "  G = " + str(g_val) + "  B = " + str(b_val))
    ...
    if option == "1":
        ...
        for s in range(start_v, end_v, skip_v):
            ...
            capture_image(s, c_val, g_val, b_val, x_dim, y_dim,
                          output_file, additonal_commands)
        ...
        for c in range(start_v, end_v, skip_v):
            ...
            capture_image(s_val, c, g_val, b_val, x_dim, y_dim,
                          output_file, additonal_commands)
        print("Range captured, view and select best value..")
        ...
        for g in range(start_v, end_v, skip_v):
            ...
            capture_image(s_val, c_val, g, b_val, x_dim, y_dim,
                          output_file, additonal_commands)
        print("Range captured, view and select best value..")
        ...
        for b in range(start_v, end_v, skip_v):
            ...
            capture_image(s_val, c_val, g_val, b, x_dim, y_dim,
                          output_file, additonal_commands)
        print("Range captured, view and select best value..")
        ...
        capture_image(s_val, c_val, g_val, b_val, x_dim,
                      y_dim, output_file, additonal_commands)
